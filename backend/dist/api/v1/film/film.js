 ...
 * @extends {IRoute}
 */
class FilmRouter extends route_1.IRoute {
    constructor() {
        super();
        this.resolver = new resolver_1.FilmResolver();
        this.film = {
            type: typedef_1.FilmType,
        ...
        this.films = {
            type: graphql_1.GraphQLList(typedef_1.FilmType),
        ...
        this.mutations = {
            film: {
                ...
                args: { element: { type: typedef_1.FilmInputType }, populate: { type: methods_1.QueryPopulateType } },
